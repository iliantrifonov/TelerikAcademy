...
// Copyright (c) 2014 Telerik Academy.
// </copyright>
//
// ********************************
namespace TelerikStringExtensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// <returns>A string that is equivalent to this instance except that its first letter is uppercase.</returns>
        ...
        /// </summary>
        /// <param name="input">This instance.</param>
        /// <returns>A string in which all instances of Latin letters are replaced with their Cyrillic equivalents.</returns>
        ...
        /// </summary>
        /// <param name="input">This instance.</param>
        /// <returns>A copy of this instance where all Cyrillic letters are replaced with their Latin equivalents and all non-alphanumeric characters (excluding the period ".") are removed.</returns>
        ...
        /// <param name="input">This instance.</param>
        /// <returns>A copy of this instance where all Cyrillic letters are replaced with their Latin equivalents, spaces are replaced with hyphens and all non-alphanumeric characters (excluding the period "." and hyphen "-") are removed.</returns>
