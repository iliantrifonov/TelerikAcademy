<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Chat.Moderation.Edit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <asp:LinkButton CssClass="btn btn-success" Text="Refresh" PostBackUrl="~/Moderation/Edit.aspx" runat="server" />
    </div>

    <asp:ListView runat="server" ID="LvMessages" ItemType="Chat.Models.Message" SelectMethod="LvMessages_GetData" UpdateMethod="LvMessages_UpdateItem" DataKeyNames="Id">
        <LayoutTemplate>
            <h2>Messages:</h2>
